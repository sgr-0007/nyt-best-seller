...
const Sidebar = () => {
  ...
  const activeClass = "relative bg-blue-500 text-white pl-11 pr-11 py-6 rounded-lg shadow-2xl";
    ...
    <div className="top-0 left-0 w-[96px] h-full bg-gray-900 text-white flex flex-col items-center py-4">
      <div className="flex flex-col items-center space-y-6 flex-1 justify-center">
        <Link to="/" onClick={() => handleLinkClick('/')}>
          <div className={`flex items-center justify-center w-full h-full ${activeLink === '/' ? activeClass : inactiveClass}`}>
        ...
        <Link to="/favourites" onClick={() => handleLinkClick('/favourites')}>
          <div className={`flex items-center justify-center w-full h-full ${activeLink === '/favourites' ? activeClass : inactiveClass}`}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6">
        ...
        <Link to="/settings" onClick={() => handleLinkClick('/settings')}>
          <div className={`flex items-center justify-center w-full h-full ${activeLink === '/settings' ? activeClass : inactiveClass}`}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6">
